...
\end{figure}
Die Helligkeit in Abhängigkeit von der horizontalen Position auf den aufgenommenen Bilder ist in Abbildung \ref{fig: blau_intensität_sigma} für das unaufgespaltene
...
\end{figure}
\input{../Messdaten/tabs/peaks_blau_sigma.tex}
