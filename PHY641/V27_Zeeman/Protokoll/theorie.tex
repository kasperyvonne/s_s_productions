...
Hierzu wird die Aufspaltung der Spektralinien einer Cadmium Spektrallampe %der Spektrallinien, nicht der Energieniveaus
...
\end{align*}
Mit $\map{g_S}$ wird der Landé-Faktor des Elektrons bezeichnet und trägt den Wert zwei. %Landé, , der den Wert 2 trägt
Auffälig ist, dass das magnetische Spinmoment $\vec{\mu}\ua{s}$ des Elektrons exakt doppelt %auffällig, in unserer Betrachtung exakt doppelt so groß
...
Der Landé-Faktor kann mit Formel %Landé, komma nach Formel zu viel
\begin{equation}
