...
Teil interferiert untereinander. Damit es zu konstruktiver Interferenz kommt, muss die Bragg-Bedingung %interferiert womit?
\begin{equation*}
  2d\cos(\theta)=n\lambda
\end{equation*}
erfüllt sein. Die in der Bragg-Bedingung auftretenden Größen sind die Dicke der Platte $d$,
die Wellenlänge $\lambda$ und die Ordnung des Maximums $n$. %Maximums
...
Zunächst werden die optische Apparatur so eingestellt, dass Licht mit einer hohen Helligkeit %Zunächst, werden, dass
...
der Landé-Faktor konstant ist (vgl. Tab. \ref{tab:Lande_rot}), lassen sich keine %erkennbar ist, kein Komma nach Zeemaneffekt, Landé
