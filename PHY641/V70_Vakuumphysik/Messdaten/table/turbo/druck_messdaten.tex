...
\begin{tabular}{S[table-format=1.3]@{${}\pm{}$} S[table-format=2.3] S[table-format=1.1]@{${}\pm{}$} S[table-format=1.1] S S S S S S[table-format=1.1]@{${}\pm{}$} S[table-format=1.1] } 
\toprule  
\multicolumn{2}{c}{$p(t) \:/\: \si{ \micro\bar}$} & \multicolumn{2}{c}{$\ln( \frac{p(t)-p_{\mathrm{g}} }{p_0-p_{\mathrm{g}}\:/\: \si{\ln( \frac{p(t)-p_{\mathrm{g}} }{p_0-p_{\mathrm{g}}}}$} & {$t_1 / \si{ \second}$} & {$t_2 / \si{ \second}$} & {$t_3 / \si{ \second}$} & {$t_4 / \si{ \second}$} & {$t_5 / \si{ \second}$} & \multicolumn{2}{c}{$\overline{t} \:/\: \si{ \second}$} \\ 
\midrule  
