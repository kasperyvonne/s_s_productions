\begin{table}
\centering
\caption{Für die Bestimmung des Saugvermögens $S$ der Turbopumpe gemessene Drücke. Die Messung wurde bei Raumtemperatur durchgeführt. Es ist $p_{\mathrm{E}}=\SI{9\pm 0.9}{\nano\bar}$ der Enddruck und  $p_{0}=\SI{10\pm 1}{\micro\bar}$ der Startdruck.}
...
\toprule
\multicolumn{2}{c}{$p(t) \:/\: \si{ \micro\bar}$} & \multicolumn{2}{c}{ $ \ln(\frac{ p(t)-p_{ \mathrm{E} } }{ p_0-p_{ \mathrm{E} } })$} & {$t_1 / \si{ \second}$} & {$t_2 / \si{ \second} $ } & {$t_3 / \si{ \second}$} & {$t_4 / \si{ \second}$} & {$t_5 / \si{ \second}$} & \multicolumn{2}{c}{$\overline{t} \:/\: \si{ \second}$} \\
\midrule
