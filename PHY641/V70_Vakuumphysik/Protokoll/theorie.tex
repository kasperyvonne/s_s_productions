...
\end{equation}
Mit der Stoffmenge $n$ und dem Moleküldurchmesser $D$. Mit fallendem Druck wächst die mittlere freie  %Zwei mal mit
...
Der Rotor einer Turbomolekularpumpe ist in Abbildung~\ref{fig: turbu} zu sehen. Dieser besteht im Wesentlichen aus einer %\ref{}
...
eine spiralförmige Anode, in derem Zentrum ein Glühdraht positioniert ist. Der Einsatz des Gerätes ist erst ab einem %Schreib anstatt von Gerät leiber I  onisationsmannometer
