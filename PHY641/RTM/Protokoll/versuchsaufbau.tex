...
verwendet, um die Spitze filigranen zu bewegen. %filigran
...
und die Veränderung des Tunnelstroms zu messen. %vielleicht noch fachabkürzung ergänzen
...
Um die Spitze exakt zu manövrieren wird neben einem Piezokristall ein geeignete Regelkreis benötigt. %geeigneter
...
Geschwindigkeit mit der auf Abweichung reagiert wird. Zum andern kann der %Abweichungen
...
Bevor mit den Materialien eine Spitze erstellt werden kan,n müssen sie mit Aceton und Propanol gereinigt werden. %kann,
...
Bei der Messung wird unterschieden, ob die Spitze von rechts nach links oder von links nach rechts %begriffe foreward und backward einführen
die Probe abrastert. Mit der Unterscheidung soll die Auswirkung von z.\,B. thermischen Drifts verringert werden. %wird damit nicht verringert aber ist überprüfbar
 Auf jeder, der in der Skizze \ref{fig: aufbau} zu Sehenden, Linie misst die Spitze eine %dargestellten, kein kommas
...
bei Gold ist nicht mit dem verwendeten Versuchsaufbau möglich, stattdessen %vielleicht grund nennen 
