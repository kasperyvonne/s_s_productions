...
\begin{equation}
  \theta = 1.
\end{equation}
%Für die Beträge der Gittervektoren geteilt durch die Anzahl der Einheitszellen ergeben sich folgende Werte:
%\begin{align}
%  \left|\vec{a}\ua{f}\right| &= \SI{1.89}{\angstrom} & \left|\vec{b}\ua{f}\right| &= \SI{1.57}{\angstrom}\\
%  \left|\vec{a}\ua{b}\right| &= \SI{1.87}{\angstrom} & \left|\vec{b}\ua{b}\right| &= \SI{1.56}{\angstrom}.
%\end{align}
%Die Winkel $\theta$ zwischen den Vektoren betragen
%\begin{equation}
%  \theta\ua{f} = \SI{85.7}{\degree} \text{bzw.} \theta\ua{b} = \SI{84.5}{\degree}.
%\end{equation}
