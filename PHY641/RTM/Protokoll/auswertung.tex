\section{Auswertung}
Zur quantitativen Auswertung der aufgenommenen RTM Bilder wird die Software \emph{gwyddion}\cite{gwyddion} %cite
...
beispielhafte Aufnahme einzusehen. Hierauf ist klar zu erkennen, dass die Struktur stark verzerrt ist. %das bedeutet?
\begin{figure}
  \centering
...
abgelesen. Die Daten sind in Tabelle \ref{tab: data} eingetragen. Hiermit wird eine Regression an eine %vlt. noch erwähnen womit du die Regressionsrechnung gemacht hast
lineare Funktion der Form
\begin{equation}
  y = m \cdot x + g
\end{equation}
durchgeführt.
\input{../Messdaten/vector_data.tex}
