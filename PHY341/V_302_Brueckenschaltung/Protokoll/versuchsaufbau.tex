...
Voltmeter bzw. der \emph{Peak-to-Peak} Einstellung des Oszilloskops gemessen. Die Untersuchung der Frequenzabhängigkeit %Setz Peak-zo-to Peak bitte mit \emph{f}
 ermöglicht in der Auswertung die Berechnung des Klirrfaktors (vgl. \eqref{eq: klirr}). % am besten vgl. \eqref{eq: klirr}
