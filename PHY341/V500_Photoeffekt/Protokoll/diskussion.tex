...
Veränderung der Lichtintensität (z.\,B. hervorgerufen durch Erschütterungen) zu einer Veränderung der gemessenen Stromstärke. %Plural
Eine weitere Unsicherheit entsteht durch das Spektrum der Hg-Lampe, denn %denn
teilweise war dies nicht diskret, sondern kontinuierlich (z.\,B. bei grün-blau). %jedes Spektrum ist nicht perfekt diskret... dass die Farben so verwischt waren lag eher an dem optischen Aufbau. Erwähn lieber noch, dass auch Farben enthalten waren, die eigentlich gar nicht dazu gehören. Der Typ meinte doch, dass da iwelche Lufteinschlüsse drin sind oder so.
...
Denn die Gegenüberstellung mit dem Theoriewert\cite{scipy} %Denn
\begin{equation}
  \label{eq:abweichung}
...
Zusammenfassend liefert der Versuch eine gute Möglichkeit den Photoeffekt untersuchen, %zu
