...
\end{figure}
Die aus der Ausgleichsrechnung erhaltenden Parameter sind in Tabelle %doppelt aus;
...
Die im vorangegangenden bestimmten Grenzspanunngen werden im %vorangegangenden was?, benutz nicht so oft wörter die auf enden enden, klingt blöd
...
\begin{equation*}
  ...
  f=\frac{\map{c}}{\lambda}.
\end{equation*}
Hierbei sei $\map{c}$ die Vaakumlichtgeschwindigkeit\cite{scipy}. %nicht sei, ist
...
zu folge haben. %zur Folge
Das asymptotische Verhalten der Stromstärke ist auf die Anode
bzw. das Streuverhalten der Elektronen zurückzuführen, denn es ist bei der verwendeten %denn
Anode nicht sichergestellt, dass alle Elektronen regrestiert werden. %registriert
...
Verstärkt wird der positive Photostrom durch das Kathoden selber, %das Kathoden?
