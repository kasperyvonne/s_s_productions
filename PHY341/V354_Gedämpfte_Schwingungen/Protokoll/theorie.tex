...
Durch einmalige äußeren Anregung z.\,B. durch einen Nadelimpuls %einmaligen, einen Nadelimpuls
...
\end{equation}
Durch Hinzunahme der bekannten Zusammenhänge %Hinzunahme
\begin{equation*}
U\ua{R}(t)=RI(t) \quad U\ua{C}(t)=\frac{Q(t)}{C} \quad U\ua{L}(t)=L\frac{\map{d}}{\map{d}t}I
\end{equation*}
und der zeitlichen Ableitung von \eqref{eq:kirch}, kann auf eine Schwingungsdifferentialgleichung %Verb fehlt
\begin{equation}
