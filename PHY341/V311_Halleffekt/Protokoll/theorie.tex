...
homogen Leiterplatte (Dicke $d$ und Breite $b$) wirkt.
...
Auf die Hallspannung kann dan gefolgert werden mit%stil
...
Bei dem Versuch ist die sogenannte Remanenz zu beachten (in \ref{fig: hyste} Punkt $\map{P}_2$). %Punkt P2
Sie steht für den Verbleib einer Remanenz-Flussdichte bei $H=0$ (Restmagnetisierung). %heißt das Remanent-Flussdichte?
