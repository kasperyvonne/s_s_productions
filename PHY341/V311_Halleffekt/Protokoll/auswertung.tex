...
\begin{align}
  \begin{aligned}
    d_{Cu} &= \SI{18}{\micro \meter} \\ %\SI verwenden
    l_{Cu} &= \SI{28.05}{\milli \meter}\\ %\SI verwenden
    b_{Cu} &= \SI{25.03}{\milli \meter} %\SI verwenden
...
Messwerte für $U_{ges+}$ und $U_{ges-}$ sowie die gemäß \eqref{eq:} berechneten Hallspannungen bei variablem Querstrom sind in den %eqref
...
erste Bestimmung der jeweiligen Teilchenzahl $n$ pro Volumen. Für die Beträge der jeweiligen Steigungen ergeben sich: %zweite jeweilig vlt durch einzelnen ersetzen
\begin{equation}
...
\begin{align}
  \begin{aligned}
    \rho_{Cu} &=  \SI{12.41(3)e-2}{\ohm \milli \meter^2 \per \meter} \\%\SI verwenden
...
\begin{align}
  \begin{aligned}
    \tau_{Cu,1} &= \SI{3.09(6)e-12}{\second} \\%\SI verwenden
    \tau_{Cu,1} &= \SI{3.01(0)e-12}{\second} \\
