...
\input{tabs/hysterese_tab.tex} %caption bei einer Tabelle drüber setzen und nicht darunter
\begin{figure}
  \centering
...
\begin{equation}
  m\ua{Cu} = (1.23 \pm 0.02)\si{\micro \volt \per \ampere}  \quad \quad m\ua{Zn} = (1.63 \pm 0.24)\si{\micro \volt \per \ampere}%\SI verwenden
\end{equation}
...
\begin{equation}
  n\ua{Cu,1} = (1.85 \pm 0.03)\cdot 10^{29}\,\si{ \meter^{-3}} \quad \quad n\ua{Zn,1} = (1.68\pm 0.24)\cdot 10^{28}\,\si{ \meter^{-3}}%\SI verwenden
\end{equation}
\input{tabs/u_h_kupfer_konstB_tab.tex} %caption bei einer Tabelle drüber setzen und nicht darunter
\input{tabs/u_h_zink_konstB_tab.tex} %caption bei einer Tabelle drüber setzen und nicht darunter
\begin{figure}
  \centering
...
\begin{equation}
  m\ua{Cu} = (0.018 \pm 0.000)\si{\milli\volt \per \tesla }  \quad \quad m\ua{Zn} = (0.020 \pm 0.002)\si{\milli\volt \per \tesla}%\SI verwenden
...
Damit ergeben sich die Werte für die Teilchenzahlen pro Volumen zu:
\begin{equation}
  n\ua{Cu,2} = (1.90 \pm 0.00)\cdot 10^{29}\,\si{ \meter^{-3}} \quad n\ua{Zn,2} = (2.09\pm 0.16)\cdot 10^{28}\,\si{ \meter^{-3}}%\SI verwenden
\end{equation}
\input{tabs/u_h_kupfer_konstI_tab.tex} %caption bei einer Tabelle drüber setzen und nicht darunter

\input{tabs/u_h_zink_konstI_tab.tex} %caption bei einer Tabelle drüber setzen und nicht darunter
...
\begin{align}
  \begin{aligned}
    \tau\ua{Cu,1} &= \SI{3.09(6)e-15}{\second} \\%\SI verwenden
...
\begin{align}
\begin{aligned}
v\ua{Cu,1} &= (33.7 \pm 0.6)\cdot10^{-3}   \si{\milli\meter\per\second}  \\%\SI verwenden
...
\begin{align}
\begin{aligned}
E\ua{Cu,1} &= (11.84 \pm 0.14) \, \si{\eV}  \\%\SI verwenden
...
\begin{align}
\begin{aligned}
\left|v\ua{Cu,1}\right| &= (2.04 \pm 0.01)\cdot 10^6 \, \si{\meter \per \second}  \\%\SI verwenden
...
\begin{align}
\begin{aligned}
l\ua{Cu,1} &= (6.31 \pm 0.08)\cdot 10^{-3} \, \si{\micro\meter}  \\%\SI verwenden
...
\begin{align}
\begin{aligned}
\mu\ua{Cu,1} &= (0.27 \pm 0.05)\cdot 10^{-3} \, \si{\meter^2 \per \volt \second}  \\%\SI verwenden
