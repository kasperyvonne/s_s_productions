...
In dem Versuch sollen zwei Proben (Kupfer und Zinn) auf den \emph{Hall-Effekt} untersucht werden. %Zink

\subsection{Hysteresemessung}
Die Hysteresemessung dient dazu, die Abhängigkeit der Magnetfeldstärke
zur Stromstärke zu bestimmen. Gleichzeitig aber auch den Effekt der Hysterese %Abhängikeit [...] von; Stil
zu bestimmen. Der Versuch wird wie in \ref{fig: auf_hall} zu sehen aufgebaut. %Kommata oder Satz anders formulieren
Mittels eines Teslameters wird nun für zehn Stromstärken das Magnetfeld bestimmt. %Mit Hilfe
Die ersten $10$ Messungen werden beim Hochfahren des Magneten getätigt. %Komma; $10$ bzw zehn konsistent
...
Mit dem Unterschied, dass beim zweiten Durchgang die Spannung umgepolt wird. %Stil
...
Die verkabelte Probe wird nun in eine Haltevorrichtung gegeben. Diese sorgt dadfür, dass %gegeben passt nicht gut; dafür
...
Die von dem Hall-Effekt erezeugt Spannugn kann dann wie folgt berechnet werden: %erzeugte Spannung

\begin{align} %Füg hier besser die fertige Formel ein 
\label{eq:hall_spann}
\begin{aligned}
