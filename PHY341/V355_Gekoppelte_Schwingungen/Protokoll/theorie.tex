...
Alle weiteren Lösungen des Systems \eqref{eq: gekoppeltes_lgs} erhält man durch Superposition. Bei diesen Lösungen handelt es sich
um Schwebungsvorgänge, die unter anderem im Versuch beobachtet werden sollen. \\
...
\end{equation}
Der Strom $I_2$ erreicht Maxima für die Fundamentalfrequenzen $\omega^+$ bzw. $\omega^-$. Der Strom $I\ua{K}$ wird unter der Frequenz $\omega^+$ minimal bzw. unter
$\omega^-$ maximal. Diese Zusammenhänge sollen im Versuch experimentell überprüft werden.
