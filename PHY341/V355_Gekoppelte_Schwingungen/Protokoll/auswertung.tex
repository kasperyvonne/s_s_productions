...
\end{equation}
Und für die gegenphasigen Fundamentalfrequenzen ergibt sich in Abhängigkeit von $C\ua{k}$ die in Tabelle \ref{fig:teilb_frequenzen_theo}  dargestellten Werte. %ohne zu
...
Schewbungsperiode (einem 'Bauch') sind in Tabelle \ref{fig:teila_n_ck} aufgelistet. %sind
...
\begin{equation*}
n\ua{theo}=\frac{\nu_{+\,\mathup{theo}}+\nu_{-\,\mathup{theo}}}{2\left(\nu_{\,\mathup{theo}}-\nu_{+\,\mathup{theo}}\right)}
\end{equation*}


%\input{table/teila_ck_n.tex}
\input{table/teila_ck_n_mit_theo.tex}
...
Die Messwerte sind in der Abbildung \ref{fig: plot} einmal aufgetragen. %Verb 
\begin{figure}
  \centering
