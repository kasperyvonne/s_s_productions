...
Die bei verschieden eingestellten $C\ua{k}$ gezählten Schwingungsmaxima pro einer halben %einer ganzen
Schewbungsperiode (einem 'Bauch') werden in Tabelle \ref{fig:teila_n_ck} aufgelistet. %sind
Zusätzlich befindet sich in der Tabelle, das Verhältnis zur Schwebungsperiode. %kein komma
Bestimmt wurde diese mittels %dieses
\begin{equation*}
...
\end{equation}
Und für die gegenphasigen Fundamentalfrequenzen ergibt sich in Abhängigkeit von $C\ua{k}$ die in Tabelle \ref{fig:teilb_frequenzen_theo} zu dargestellten Werte. %ohne zu
...
\FloatBarrier
In Abbildung \ref{fig: plot} sind die Messwerte grraphisch dargestellt. %graphisch
...
Die Messwerte in der Abbildung \ref{fig: plot} einmal aufgetragen. %Verb 
\begin{figure}
  \centering
