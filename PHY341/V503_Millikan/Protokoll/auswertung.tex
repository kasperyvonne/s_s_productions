...
Die aus der Anleitung entnommenen Werte Paare $(R, T)$ (siehe Tabelle \ref{tab: thermowiderstand}) wurden benutzt um den Zusammenhang %ref
...
\input{../Messdaten/tabs/thermowiderstand.tex}
\begin{figure}[H]
  \centering
...
\input{../Messdaten/tabs/daten_V503.tex}
...
Ladungen sollten der Theorie zur Folge ein ganzzahliges Vielfachhes von $\mathup{e}\ua{0}$ sein, das heißt für die %\map{e}
...
\end{equation}
\input{../Messdaten/tabs/q_best.tex}
\begin{figure}[H]
  \centering
