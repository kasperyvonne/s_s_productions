...
#
#l.Latexdocument('tabs/daten_V503.tex').tabular([resistance.magnitude, T.magnitude, eta.magnitude*1e5, radius.to('micrometer').magnitude, time.magnitude, v.magnitude,
...
#   [2, 2, 2, 1, 3, 3, 2, 2, 2], label = 'data', caption = 'Gemessene und brechnete Größen für einzelne beobachtete Tropfen. Thermowiderstand $R$, Temperatur $T$, Luftviskosität $\eta$, Tröpfchenradius $r$, Fallzeit $t$, Fallgeschwindigkeit $v_0$, Schwebespannung $U$ und korrigierte Ladung $q$.')
