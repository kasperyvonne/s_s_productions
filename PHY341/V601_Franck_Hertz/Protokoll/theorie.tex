...
Nun kommt es zu elastischen und inelastischen Stößen zwischen den Elektronen und den \ce{Hg}-Atomen. Gemäß
...
\ce{Hg}-Atom finden immer dann statt, wenn die Energie $E\ua{kin}$ mindestens der Energiedifferenz $E\ua{1} - E\ua{2}$
...
\ce{Hg}-Atoms. Dieses kehrt nach einem kurzen Zeitabstand unter Aussendung eines Lichtquants der Energie
\begin{equation}
  h\nu = E\ua{2} - E\ua{1}
\end{equation}
...
\ce{Hg}-Atom zu klein ist um die Gegenspannung zu überwinden. Der theoretische Verlauf des Zusammenhang zwischen
