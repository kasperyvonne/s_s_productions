...
Im Versuch US $1$ wird ein Ultraschallechoskop, eine Ultraschallsonden und ein Rechner %sonde
zum Verarbeiten der Daten verwendet.
Als Probe werden aus Acryl gefertigte Zylinder und Quader verwendet.
Zusätzlich wird auch ein Augenmodel (vgl. \ref{fig: auge}) untersucht. %modell
...
Wie in der Theorie angesprohen besitzt Luft einen hohen Absopttionskoeffizient, deshalb wird %angesprochen, Absorptionskoeffizient
auf den Proben entweder \emph{bidestilliertes Wasser} oder eine \emph{spezielle Kontaktcreme} %spezielle nicht kursiv
...
eingegangenen Signal auf. %signals
