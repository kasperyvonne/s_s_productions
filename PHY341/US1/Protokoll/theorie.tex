...
longitudinal (wie zum Beispiel in Flüssigkeiten), sondern auch als %longitudinal
Transversalwellen ausbreiten.
Außerdem besitzt die Schallgeschwindigkeit in Festkörpern eine Richtungsabhängigkeit. %Festkörpern
...
Bei der Ausbreitung verliert die Welle somit Enegerie bzw. an Intensität $I(x)$:  %ungünstig formuliert
\begin{equation}
  \label{eq:abfall}
...
zusätzlich eine polare Achse des Kristalls parallel zum E-Feld, wird dieser %Kristalls
...
Schallenergiedichten möglich. %energiedichten
...
\begin{figure}[h]
  ...
  \label{fig: echo}
  \end{figure}
Die erzeugte Schallwelle wird an der Grenzfläche reflektiert und von der Sonde %an der
