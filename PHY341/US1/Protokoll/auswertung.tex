...
\begin{align}
  ...
  \end{aligned}
\end{align}
\input{../Messdaten/tabs/c_echo.tex}
\begin{figure}[H]
  \centering
...
\input{../Messdaten/tabs/c_durchschallung.tex}
\begin{figure}[H]
  \centering
...
\input{../Messdaten/tabs/cepstrum.tex}
\begin{figure}[H]
  \centering
...
\ref{fig: auge} eingezeichnet. Hierbei werden die Peaks als Reflexionen an Hornhaut, Linse (Ein- und Ausgang) und Retina interpretiert. %Sollten nicht 5 Peaks erkennbar sein: Hornhaut, Iris, Linse eingang, Linse ausgang unf die Retina?
