...
einer Torsionsfeder. Um die Winkelrichtgröße zu bestimmen. %Ausdruck
...
Die Funktionsparameter lassen sich mittels linearer Regression bestimmen. %besser: zwischen T^2 und a^2 besteht einer linearer Zusammenhang, die  	Funktionsparameter lassen sich mittels linearer Regerssion bestimmen...
...
Um das Eigenträgheitsmoment der Drillachse zu bestimmen, werden die Trägheitsmomente der kleinen Zylinder 
und der Stange benötigt.
Die Trägheitsmomente der Zylinder werden mittels \eqref{eq:traeg_zylinder_schwer} berechnet und 
das der Stange durch

\begin{equation*}
I_{S}=\frac{1}{12}mh^2.
\end{equation*}

Es ergibt sich für das Eigenträgheitsmoment:
...
Theoretische und experimentelle Befunde stimmen somit über ein. %Ich würde den qualitativen Vergleich zwischen Theorie und Experiment in der Diskussion anstellen
...
Die Abweichung zwischen Theoie und Experiement beläuft sich auf $\approx +13 \%$ %was heißt das?
