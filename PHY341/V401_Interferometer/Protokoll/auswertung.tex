...
\input{./table/abstands_messung.tex}
...
} der Brechungsindex bestimmt werden. Hierbei sind die Konstanten als $T=\SI{293.15}{\kelvin},\, T_0=\SI{273.15}{\kelvin} \, %woher kommen die temperaturen?
\text{und} \, p_0=\SI{1.0132}{\bar}$ gegeben.
Die Messresultate sind in Tabelle \ref{tab: tab: messwerte_luft} aufgeführt.
\input{./table/brechung_luft.tex}
...
\input{./table/brechung_kohlenstoff.tex}

Die sich daraus folgenden Mittelwerte lauten %falsches wort
\begin{align}
