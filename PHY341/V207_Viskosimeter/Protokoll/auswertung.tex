...
\begin{aligned}
\overline{m}_{1}&=  \SI{0.00444}{\kilogram} \\
\overline{m}_{2}&= \SI{0.00460}{\kilogram} \\
\hfill \\
\overline{d}_{1}&= \SI{0.0151}{\meter} \\
\overline{d}_{2}&= \SI{0.0153}{\meter} \\
\hfill\\
\overline{r}_{1}&= \SI{0.0076}{\meter} \\
\overline{r}_{2}&= \SI{0.0077}{\meter} \\
\end{aligned}
\end{align}
...
\eta_{20}= \SI{0.0014}{\pascal\second}
\end{equation}
