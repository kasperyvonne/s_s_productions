...
Literaturwert $\rho_{20}=\SI{998.21}{\kilogram\per\cubic\meter}$ angenommen\cite{lit_dichte}. %Wichtig: Literaturverweis angeben
...
Als Dichte des Wasser wurden folgende Dichten angenommen \cite{lit_dichte}:  %Noch literatur ref
