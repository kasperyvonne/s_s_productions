...
der Bestimmung für den Zylinder. Auch hier sind die gemessenen Schwingungsdaueren im Anhang einzusehen.
Als gemittelter Wert ergibt sich:
...
theoretischen Werten. Denn bei der Berechnung muss die Form der Puppe 
...
Satz von Steiner zu berücksichtigen ist. Dabei sind die Verschiebungen zur Drehachse
\begin{align*}
a_{arm}&=\num{9.27e-2}\si{\meter}\\
a_{bein}&=\num{1.19e-2}\si{\meter}
\end{align*}
