...
\end{align*}
zeigt sich, dass der Versuchsaufbau genaue Ergebnisse bei Untersuchung von Emissionsspektren %der Untersuchung
liefert.

Werden die Ergebnisse für $E\ua{K}$ mit der Literatur \cite{k_kante} verglichen (vgl. Tab. \ref{tab: result_comp}),
so wird deutlich, dass der Versuchsaufbau eine gute Möglichkeit bietet, um die $E\ua{K}$ verschiedener %nomen
...
Die aus dem Versuch resultierende Rydbergenergie $R_\infty=\SI{14.11\pm0.15}{\eV}$ weicht zum Literaturwert \cite{anleitung602} %vom
...
Allgemein ist Auflösungsvermögen ein Maß für den geringsten Abstand zweier Beobachtungspunkte, %das
