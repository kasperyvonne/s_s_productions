...
\begin{figure}
  ...
  \caption{Auftragung der experimentell berechneten Energien $E\ua{K}$ gegen die Kernladungszahl $Z$. Zusätzlich ist in der Abbildung die zugehörige Ausgleichsgerade zu sehen.} %tragung
  \label{fig: ryd_ener}
\end{figure}
