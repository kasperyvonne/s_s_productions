...
Aus Gleichung \eqref{eq: abbildungsgesetz_gross}  %Referenzierung
...
\end{equation*}
Unter der Bedingung, dass zwischen den beiden Linsen kein Abstand existiert. %Bedingung, dass...existiert
