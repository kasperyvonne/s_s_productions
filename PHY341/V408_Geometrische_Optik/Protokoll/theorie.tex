...
Aus Gleichung \eqref{eq: abbildungsgesetz_gross} bzw. \eqref{eq: abbildungsgesetz_klein} %Referenzierung
...
\end{equation*}
Unter der Bedingung das zwischen den beiden Linsen kein Abstand exestiert. %Bedingung, dass...existiert
