\section{Auswertung}
Für die gemessenen Strecken wurde jeweils ein Fehler von $\SI{1}{\milli\meter}$ angenommen. %Würde den Satz anders anfangen, zweimal für
...
\begin{figure}
  ...
  \label{fig: methode_1}
\end{figure}
\input{../Messdaten/tabs/methode_1.tex}
...
Die aufgenommen Daten sind in Tabelle \ref{tab: wasserlinse} eingefügt. Die graphische Darstellung der Verbindungslinien ist %aufgenommenen
...
\end{equation}
\input{../Messdaten/tabs/wasserlinse.tex}
\begin{figure}
  \centering
...
\begin{equation}
  ...
  \label{eq: f_bessel}
\end{equation}
\input{../Messdaten/tabs/bessel.tex}
...
\end{align}
\input{../Messdaten/tabs/colors.tex}
...
berechneten Werte für $(1 + \frac{1}{V})$ und $(1 + V)$ einzusehen. Eine graphische Darstellung der Funktionen \eqref{eq: abstaende_abbe_g} %Kannst du noch vermerken das die weiten g' und b' von der Sammellinse asugemessen wurden
